...
/*
     ...
     6.8.95:
     - Sonderbehandlung fÅr 1 Plane ergÑnzt: Andreas Kromke

     25.11.95:
     - Da das MagiC-VDI mittlerweile vq_scrninfo() unterstÅtzt, wird bei 
...
extern    WORD vintout[];                              /* intout fÅr VDI-Aufrufe */
extern    void *xp_tab;
...
/* Funktionsresultat:    0: nicht unterstÅtztes Format                          */
/*                       1: alles in Ordnung, Format wird unterstÅtzt           */
/*                       -1: Format muû nicht gewandelt werden                  */
/*                                                                              */
