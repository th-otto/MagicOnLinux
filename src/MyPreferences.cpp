...
CMyPreferences::CMyPreferences()
{
	...
	m_drvFlags['C'-'A'] |= 2;		// C: drive has 8+3 name scheme
	...
	*/
	...
	m_bAutoStartMagiC = true;
	m_KeyCodeForRightMouseButton = -1;		// TODO: find it
	strcpy(m_szPrintingCommand, "echo printing not yet implemented");
	m_AtariScreenX      = 100;
	m_AtariScreenY      = 100;
	m_AtariScreenWidth  = 640;
	m_AtariScreenHeight = 480;
	m_ScreenRefreshFrequency = 60;
	m_bPPC_VDI_Patch = false;
}
